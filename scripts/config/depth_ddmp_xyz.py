...
def Config():
    ...
    conf.task_w = 1
    conf.alias = 'Adaptive_block2_ddmp_xyz'
    conf.result_dir = 'Adaptive_block2_ddmp_xyz'
    ...
    if conf.depth_channel == 3:
        ...
        conf.depth_mean = [-0.36004645, -0.1542382, 17.003899]#[107.0805491, 68.26778312, 133.50751215]  # MONO2
        conf.depth_std = [0.88803226,0.13138394,3.336821]#[38.65614623, 73.59464917, 88.24401221]
